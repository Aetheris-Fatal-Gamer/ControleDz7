...
class AddedChest {
    ...
    public function handle(Interaction $interaction, Discord $discord): void {
        ...
        $interaction->showModal('Adicionar no baú' . $passport, 'added_chest', $this->actionsRows);
    }
    ...
    private function buildActionsRows(Interaction $interaction): void {
        ...
        $currentTotalInput = TextInput::new('Total no baú:', TextInput::STYLE_SHORT, 'currentTotal')
            ->setRequired(true)
            ->setPlaceholder('Ex: 210');
        $currentTotalRow = ActionRow::new()->addComponent($currentTotalInput);
